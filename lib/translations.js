const translations = {
  es: {
    ...
    testimonials: {
      ...
      subtitle: 'He tenido el privilegio de trabajar con profesionales increíbles que respaldan mi compromiso y liderazgo técnico.',
      items: [
        {
          text: 'Axel siempre ha sido un miembro clave del equipo. Es alguien que da un paso al frente para ayudar al líder de desarrollo siempre que surge la oportunidad. Desde una perspectiva no técnica, veo que los demás desarrolladores acuden a él como fuente de conocimiento y como un mentor siempre dispuesto a intervenir y ofrecer orientación.',
          role: 'Project Manager Accenture / Team Member'
        },
        {
          text: 'En general, Axel ha demostrado habilidades y conocimientos técnicos excepcionales durante todo el proyecto. Su experiencia en el diseño de la arquitectura de la aplicación lo consolidó rápidamente como un líder técnico dentro del equipo.',
          role: 'Tech Lead Accenture / Collaborator'
        },
        {
          text: 'Trabajar con Axel fue una experiencia fantástica. Regularmente transformaba mockups en interfaces de usuario altamente funcionales que eran indistinguibles de su diseño inicial.',
          role: 'Lead Designer Accenture / Colleague'
        }
      ]
    },
  ...
  en: {
    ...
    testimonials: {
      ...
      subtitle: 'I have had the privilege of working with amazing professionals who back my commitment and technical leadership.',
      items: [
        {
          text: 'Axel has always been a significant team member. He is one that steps up to assist the dev lead wherever the opportunity arises. From a non-developer perspective, I see the other developers looking to him as a source of knowledge and a mentor who is always willing to step in and provide guidance.',
          role: 'Project Manager Accenture / Team Member'
        },
        {
          text: 'Overall, Axel has demonstrated exceptional technical knowledge and skills throughout the project. His expertise in designing the app\'s architecture quickly established him as a technical leader within the team.',
          role: 'Tech Lead Accenture / Collaborator'
        },
        {
          text: 'Working with Axel was a fantastic experience. He regularly transformed mockups into high functioning front ends that were indistinguishable from their initial design.',
          role: 'Lead Designer Accenture / Colleague'
        }
      ]
    },
