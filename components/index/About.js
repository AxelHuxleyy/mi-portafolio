                ...
                <div className="flex flex-wrap justify-between shadow-lg bg-white rounded-xl ">
                    ...
                    <div className="max-w-screen-sm p-5    ">
                        ...
                        <div className="mt-3 pl-5 font-thin text-2xl lg:border-r-2 md:border-b-0 sm:border-b-2  border-b-2 border-gray-100">
                            ...
                            <p className="mt-2">Responsible.</p>
                        ...
                        <h1 className='text-4xl text-black font-sans mt-10 text-center'>Language</h1>
                        ...
                        <div className="max-w-screen-sm p-5">
                            ...
                            <p className='text-justify text-black  mt-10 font-thin text-xl'>
                                👋Hello! I am Axel Huxley, recently graduated in software development engineering 
                                from the computer science faculty at the Universidad Autonoma de Querétaro.
                            </p>
                            ...
                            <p className="text-justify text-black  mt-3 font-thin text-xl">
                                ...
                                the entirent procees in building the application to deployment it for production

                                i like on been on all process. that meand that i like fron-end  and back end of deployment. i like procesing for bulding application and deploy for production 
                            </p>
                            ...
                            <p className="text-justify  text-black mt-3 font-thin text-xl">
                                🎯 My goal is to develop my professional career as a web or mobile developer. Until I can 
                                become a full-stack JavaScript developer, I would like to be part of a company in which 
                                I am allowed to apply all that I have learned so far and continue to grow both personally 
                                and professionally to achieve the best possible results.
